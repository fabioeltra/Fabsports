...
<head>
	...
	<title>Fabsports. | Conquer The Game</title>
			...
			<div class="furniture-container homepage-container">
				...
				<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
					<div class="more-info-tab clearfix">
						<h3 class="new-product-title" style="color: #1b1b1b; text-align: center; font-size: 40px; margin-top: 30px; font-family: 'FjallaOneRegular';">Featured Products</h3>
					</div>
												...
												<div class="product">
													<div class="product-image">
														<div class="image">
															<a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>">
																<img src="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" style="width: 100%; aspect-ratio: 1;"></a>
														</div><!-- /.image -->
													...
													<div class="product-info text-left">
														...
														<div class="product-price">
															<span class="price">
																Rp. <?php echo " " . number_format($row['productPrice'], 0, ',', '.'); ?> </span>
