...
// Fetch the product name to dynamically generate the page title
$sql_product = mysqli_query($con, "SELECT productName FROM products WHERE id='$pid'");
$product_data = mysqli_fetch_array($sql_product);
$productName = $product_data['productName'];

// Default title if product name is not found
$title = isset($productName) ? $productName : "Product Details - My Website";
			...
			<div class="breadcrumb-inner">
				...
				?>
					...
					<ul class="list-inline list-unstyled">
						...
						<li style="margin-right: 0;"><?php echo htmlentities($rw['catname']); ?></a></li>
										...
										<div class="products">
											<div class="hot-deal-wrapper">
												<div class="image">
													...
													<img src="admin/productimages/<?php echo htmlentities($rws['id']); ?>/<?php echo htmlentities($rws['productImage1']); ?>" style="width: 100%; aspect-ratio: 1;">
												</div>
											...
											<div class="product-info text-left m-t-20">
												...
												<div class="product-price">
													<span class="price">
														Rp. <?php echo " " . number_format($rws['productPrice'], 0, ',', '.'); ?>
													</span>

													<span class="price-before-discount">
														Rp. <?php echo " " . number_format($rws['productPriceBeforeDiscount'], 0, ',', '.'); ?>
													</span>
												</div><!-- /.product-price -->
											</div><!-- /.product-info -->
						...
						<div class="row  wow fadeInUp">
							...
							<div class='col-sm-6 col-md-7 product-info-block'>
								<div class="product-info">
									<h1 class="name" style="color: #1b1b1b; font-size: 40px; line-height: 1.4;"><?php echo htmlentities($row['productName']); ?></h1>
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="price-box">
													...
													<span class="price-before-discount">
														Rp <?php echo " " . number_format($row['productPriceBeforeDiscount'], 0, ',', '.'); ?>
													</span>
												</div>
											</div>
					...
					<div class="products">
						<div class="product">
							<div class="product-image">
								<div class=" image">
									<a href="product-details.php?pid=<?php echo htmlentities($rw['id']); ?>"><img src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']); ?>/<?php echo htmlentities($rw['productImage1']); ?>" style="width: 100%; aspect-ratio: 1;"></a>
								</div><!-- /.image -->
							...
							<div class="product-info text-left">
								...
								<div class="product-price">
									<span class="price">
										Rp <?php echo " " . number_format($rw['productPrice'], 0, ',', '.'); ?></span>
									<span class="price-before-discount">Rp
										<?php echo " " . number_format($rw['productPriceBeforeDiscount'], 0, ',', '.'); ?></span>
