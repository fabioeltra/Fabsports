									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">League</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Apparel</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Product Price Before Discount (Rp)</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Product Price (Rp)</label>
												<div class="controls">
...
<?php echo htmlentities($row['productDescription']); ?>
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Product Shipping Charge (Rp)</label>
												<div class="controls">
