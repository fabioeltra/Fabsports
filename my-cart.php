		...
		<div class="container">
			<div class="row inner-bottom-sm">
				<div class="shopping-cart">
													...
													<tr>
														...
														<td class="cart-image">
															<a class="entry-thumbnail" href="detail.html">
																<img src="admin/productimages/<?php echo $row['id']; ?>/<?php echo $row['productImage1']; ?>" alt="" width="114" height="114">
															</a>
														</td>
														...
														<td class="cart-product-sub-total"><span class="cart-sub-total-price">Rp <?php echo " " . number_format($row['productPrice'], 0, ',', '.'); ?></span></td>
														<td class="cart-product-sub-total"><span class="cart-sub-total-price">Rp <?php echo " " . number_format($row['shippingCharge'], 0, ',', '.'); ?></span></td>
								...
								<tr>
									<th>
										...
										<div class="cart-grand-total">
											Total<span class="inner-left-md">Rp <?php echo " " . number_format($_SESSION['tp'] = "$totalprice", 0, ',', '.'); ?></span>
										</div>
									</th>
								</tr>
							</thead><!-- /thead -->
					...
					<?php } else {
									echo "<h4 style='color: #1b1b1b; text-align: center;'>Your shopping Cart is empty</h4>";
								} ?>
					</div>
				</div>
			</div>
