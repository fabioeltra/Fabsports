			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
					...
					<div class="logo">
						...
						<img src="img/logo/logo.png" style="width: 80%;">
					...
					<div class="search-area">
						<form name="search" method="post" action="search-result.php">
							<div class="control-group">
								...
								<input class="search-field" placeholder="Search here..." name="product" required="required" style="width: 84%;"/>

								<button class="search-button" type="submit" name="search" style="border: none; background: transparent;"></button>
						...
						<div class="dropdown dropdown-cart">
							<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
								<div class="items-cart-inner">
									...
									<div class="basket-item-count"><span class="count" style="position: absolute; right: 7px; top: 1px;">0</span></div>
