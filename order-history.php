				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['proid'];?>/<?php echo $row['pimg1'];?>" alt="" style="width: 30%;">
						</a>
					</td>
					...
					<td class="cart-product-sub-total"><?php echo date('d M Y', strtotime($row['odate'])); ?>  </td>
